...
struct DeviceType {
    ...
    static let isIphoneXOrBigger    = UIScreen.main.bounds.height >= 812
    static let isIphone8OrSmaller   = UIDevice.current.userInterfaceIdiom == .phone && UIScreen.main.bounds.height <= 736
}
